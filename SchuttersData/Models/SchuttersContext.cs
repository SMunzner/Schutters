...
//        => optionsBuilder.UseSqlServer("Server=(localdb)\\mssqllocaldb;Database=Schutters;Trusted_Connection=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Lid>(entity =>
        {
            ...
            entity.HasOne(d => d.ClubNavigation).WithMany(p => p.Leden)
